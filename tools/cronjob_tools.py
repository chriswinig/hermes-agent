...
Important safety rule: cron-run sessions should not recursively schedule more cron jobs.""",
    "parameters": {
        ...
        "properties": {
            ...
            "script": {
                "type": "string",
                "description": "Optional path to a script that runs before each cron job execution. Its stdout is injected into the prompt as context. Use for data collection and change detection. Python and shell scripts are supported. Relative paths resolve under ~/.hermes/scripts/. On update, pass empty string to clear."
            },
        },
        "required": ["action"]
    }
