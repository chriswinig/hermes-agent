...
def _build_job_prompt(job: dict, prerun_script: Optional[tuple] = None) -> str:
    ...
    cron_hint = (
        ...
        "STYLE: Keep the final response as a high-level summary only. "
        "Do NOT include cron job IDs, run IDs, schedules, success boilerplate, "
        "or management instructions like how to stop/manage the job. "
        "Only mention failure mechanics if the job actually failed and the user "
        "needs to act. "
